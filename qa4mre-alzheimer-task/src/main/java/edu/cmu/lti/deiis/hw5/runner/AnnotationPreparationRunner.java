 ...
 * 
 */
public class AnnotationPreparationRunner extends Thread {
	/**
	 * The CPE instance.
	 */
	 ...
	 *            description
	 */
	public AnnotationPreparationRunner(String args[]) throws Exception {
		mStartTime = System.currentTimeMillis();
		if (args.length == 0) {
			args = new String[1];
			args[0] = new String("src/main/resources/AnnotationPreparationDescriptor.xml");
		}
	...
	public static void main(String[] args) throws Exception {
		new AnnotationPreparationRunner(args);
	}
